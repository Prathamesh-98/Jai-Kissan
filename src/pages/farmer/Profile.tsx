...
import { User, MapPin, Phone, Mail, Edit2, Camera, Save } from 'lucide-react';
            ...
            >
              <Card className="p-6">
                <div className="space-y-6">
                  <div>
                    <h3 className="text-lg font-medium text-gray-900 mb-4">Farming Details</h3>
                      ...
                      <div>
                        ...
                        {isEditing ? (
                          <Input
                            ...
                            onChange={(e) => setProfileData({ ...profileData, primaryCrops: e.target.value.split(', ') })}
                            fullWidth
                          />
                        ) : (
                          <p className="mt-1 text-sm text-gray-900">{profileData.primaryCrops.join(', ')}</p>
                        )}
                      </div>
                      <div>
