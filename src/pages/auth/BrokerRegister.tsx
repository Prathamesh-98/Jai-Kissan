...
import { Mail, Lock, Phone, MapPin, User, ArrowRight, Building } from 'lucide-react';
        ...
        const success = await register(
          {
            ...
            email: firebaseUser.email,
            phone: '+1234567890', // Placeholder phone for Google auth
            location: 'Google Auth User' // Placeholder location for Google auth
          },
          'google-auth-token', // Placeholder password for Google auth
          'broker'
        );
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <div className="flex justify-center">
          <motion.div 
            className="w-16 h-16 bg-secondary-600 rounded-full flex items-center justify-center"
        ...
        >
          Create your account to connect with farmers and access market data
        </motion.p>
      </div>
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              <Button
                ...
                fullWidth
                isLoading={isLoading}
                className="bg-secondary-600 hover:bg-secondary-700 focus:ring-secondary-500"
              >
                Register
              </Button>
            </div>
          ...
          <div className="mt-6">
            ...
            <div className="mt-6">
              <button
                ...
                className="w-full flex justify-center items-center py-3 px-4 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-secondary-500 shadow-sm transition-colors duration-200"
              >
            ...
            <div className="mt-6 text-center">
              <Link
                to="/broker/login"
                className="inline-flex items-center font-medium text-secondary-600 hover:text-secondary-500"
              >
