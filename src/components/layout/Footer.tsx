      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-1">
            <div className="flex items-center mb-4">
              <div className="w-10 h-10 bg-white rounded-full flex items-center justify-center">
                <span className="text-primary-800 text-lg font-bold">FP</span>
              </div>
              <span className="ml-2 text-lg font-bold">Farmer's Portal</span>
            </div>
            <p className="text-sm text-primary-100">
              Supporting farmers with real-time information for better decision making.
            </p>
          </div>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2 text-sm text-primary-100">
              ...
              <li><a href="#" className="hover:text-white">Crop Prices</a></li>
              <li><a href="#" className="hover:text-white">Weather Forecast</a></li>
        ...
        <div className="mt-8 pt-8 border-t border-primary-700 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-primary-200">
            &copy; {new Date().getFullYear()} Farmer's Portal. All rights reserved.
          </p>
          <div className="mt-4 md:mt-0 flex items-center text-sm text-primary-200">
            <span>Made with</span>
